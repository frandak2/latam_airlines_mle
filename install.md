# latam_airlines_mle guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `latam_airlines_mle/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `latam_airlines_mle` folder and use the modules inside your notebooks :
...
```python
from latam_airlines_mle.utils.paths import data_dir
data_dir()
```
